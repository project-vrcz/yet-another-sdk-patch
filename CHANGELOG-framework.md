...
- Use `CompilationPipeline.RequestScriptCompilation()` to reload domain when enabling or disabling patches instead of applying/unapplying patches at runtime. [`#42`](https://github.com/project-vrcz/yet-another-sdk-patch/issues/42)
...
- **BREAKING CHANGE** Migrate to JSON-based settings system. [`#35`](https://github.com/project-vrcz/yet-another-sdk-patch/pull/35)
  - You will lost log level, patches enabled settings after this update.
...
[unreleased]: https://github.com/project-vrcz/yet-another-sdk-patch/compare/framework-v0.3.0...HEAD
[0.3.0]: https://github.com/project-vrcz/yet-another-sdk-patch/compare/framework-v0.2.1...framework-v0.3.0
[0.2.1]: https://github.com/project-vrcz/yet-another-sdk-patch/compare/framework-v0.2.0...framework-v0.2.1
