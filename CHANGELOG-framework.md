...
- Allow user disable patch when patch error from gui.

#### Changed

- \[BREAKING CHANGE\] All Patches are enabled by default.
- \[BREAKING CHANGE\] Patch failed won't disable patch now.
